...
<script lang="ts">
  ...
  import { getWorkOrderDetailByMachineReturn, addWorkOrderByMachineReturn, getWorkOrderLog, updateWorkOrderByMachineReturn } from '/@/api/workOrder/workOrder';
  import { machineReturnSchemas } from './data';
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      async function getWorkOrderDetail() {
        try {
          loading.value = true;
          const response = await getWorkOrderDetailByMachineReturn({WorkOrderId: props.WorkOrderId});
          loading.value = false;
      ...
      async function create(values) {
        ...
        try {
          await addWorkOrderByMachineReturn(params);
      ...
      async function update(values) {
        ...
        try {
          await updateWorkOrderByMachineReturn(params);
