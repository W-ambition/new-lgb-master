  ...
  return [
    {
      ...
      customRender: ({ record }) => {
        ...
        const thumbUrl = url.indexOf('//') > -1 ? url : `${fileUrl}${url}`;
        return isImgTypeByName(thumbUrl) && <ThumbUrl fileUrl={thumbUrl} />;
      },
    },
    {
      dataIndex: 'name',
...
export function createPreviewActionColumn({
  ...
  return {
    ...
    fixed: false,
    customRender: ({ record }) => {
      const thumbUrl = record.url.indexOf('//') > -1 ? record.url : `${fileUrl}${record.url}`;
